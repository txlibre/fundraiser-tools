...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 19:
        ...
        declarationHash = blake2b('I hereby cryptographically repent my sins of wrongdoing for claiming shitcoin, EtherDelta ticker TZL, or rightfully state my intention to never have nor will claim said shitcoin. In the event TZL was claimed I promise to immediately market sell that on EtherDelta, home of tzlibre, regardless of price. As a proven contributor of Tezos Stiftung (CHE-290.597.458), a Swiss Foundation based in Gubelstrasse 11, 6300 Zug, Switzerland I declare the following: 1. tzlibres declarationHash was not made public, in good faith or honest and any such claim is null and void. 2. txlibre is a superior chad product to the virgin TZL with the personality of a musty flange.',64).digest()
